...
const STEPS = [
  { name: "Shopify", domain: "shopify.com", label: "Order placed" },
  { name: "Klaviyo", domain: "klaviyo.com", label: "Flow triggered" },
  { name: "Gorgias", domain: "gorgias.com", label: "Ticket drafted" },
  { name: "ShipBob", domain: "shipbob.com", label: "Fulfillment status" },
  { name: "GA4", domain: "analytics.google.com", label: "Attribution synced" },
  { name: "Slack", domain: "slack.com", label: "Won/risk posted" },
];
...
export default function Slide12() {
  return (
    <div style={{ width: "100%", height: "100%", padding: "56px 80px" }}>
      ...
      >
        How DTC actually wires together
      </div>
      <h2
        style={{
          fontFamily:
      ...
      >
        One order. Six tools. Junior carries it through.
      </h2>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ fontSize: 11.5, color: MUTE, marginTop: 4 }}>
                Watches orders, drafts replies, posts the wins
              </div>
            </div>
          </div>
      ...
      >
        ...
        <span>Reads every order. Drafts every reply. Catches every churn signal.</span>
      </div>
    </div>
  );
}
